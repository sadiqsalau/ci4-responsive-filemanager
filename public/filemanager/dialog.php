...
$config = $GLOBALS['config'] = include 'config/config.php';
...
if (!$ftp) {
    ...
    while ($cycle && $i < $max_cycles) {
        ...
        if (file_exists($config['current_path'] . $parent . "config.php")) {
            ...
            $config = $GLOBALS['config'] = array_merge($config, $configTemp);
            $cycle = FALSE;
        }
...
if (isset($_GET["descending"])) {
    $descending = $GLOBALS['descending'] = $_SESSION['RF']['descending'] = fix_get_params($_GET["descending"]) == 1;
} else {
    $descending = $GLOBALS['descending'] = $_SESSION['RF']['descending'];
}
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="tui-image-editor/tui-image-editor.min.css">
        ...
        <link type="text/css" href="node_modules/tui-color-picker/dist/tui-color-picker.css" rel="stylesheet">
        ...
        <script type="text/javascript" src="node_modules/tui-color-picker/dist/tui-color-picker.js"></script>
        <script src="tui-image-editor/tui-image-editor.min.js"></script>
